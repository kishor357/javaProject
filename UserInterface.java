...
public class UserInterface {
    ...
    public static void USER_INTERFACE(String Email){
        ...
        try {
            ...
            //statement.execute("drop table if exists UserInterface");
            statement.execute("CREATE TABLE IF NOT EXISTS UserInterface( Email text, purchase_date DATE, puff_quantity integer, bun_quantity integer, bread_quantity integer, toast_quantity integer, doughnut_quantity integer, rolls_quantity integer, Rate integer, Sum integer)");
    ...
    public static void insertIntoUser(Statement statement,String Email, String pd, int pq, int bq, int brq, int tq, int dnq, int rq, int rate, int sum ) throws SQLException{
        statement.execute("insert into UserInterface(Email, purchase_date, puff_quantity, bun_quantity, bread_quantity, toast_quantity, doughnut_quantity, rolls_quantity, Rate, Sum)" +
